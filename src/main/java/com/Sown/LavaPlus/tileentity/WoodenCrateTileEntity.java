...
public class WoodenCrateTileEntity extends LockableLootTileEntity {
    ...
    public WoodenCrateTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }

    public WoodenCrateTileEntity() {
        this(ModTileEntityTypes.WOODEN_CRATE.get());
    }
    ...
    protected Container createMenu(int id, PlayerInventory player) {
        return new WoodenCrateContainer(id, player, this);
    }
    ...
    protected void onOpenOrClose() {
        ...
        if (block instanceof WoodenCrate) {
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof WoodenCrateTileEntity) {
                return ((WoodenCrateTileEntity) tileentity).numPlayersUsing;
            }
        }
        return 0;
    ...
    public static void swapContents(WoodenCrateTileEntity te, WoodenCrateTileEntity otherTe) {
